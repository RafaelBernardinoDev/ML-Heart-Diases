...
formulario = dbc.Container([
    html.H1('Previsão de Doença Cardíaca', style={'textAlign': 'center'}),
    html.P('Preencha os dados abaixo para rodar o modelo.', style={'textAlign': 'center'}),
        dbc.Row([
            dbc.Col([
                dbc.CardGroup([
                    dbc.Label("Idade"),
...
def prever(n_clicks, age, sex, cp, trestbps, chol, fbs, restecg, thalach, exang, oldpeak, slope, ca, thal):
    ...
    if previsao == 1:
        return html.H2("Segundo o modelo você pode ter doença cardíaca.", style={'color': 'orange'},className='text-center mb-5'), html.P("LEMBRE-SE QUE É APENAS UM MODELO DE TESTE ACADÊMICO.RESULTADO SEM VALIDADE MÉDICA LEGAL", 
                                                                                                             style={'color': 'red'},
                                                                                                             className='text-center mb-3')
    else:
        return html.H2("Segundo o moledo você pode não ter doença cardíaca", style={'color': 'green'}, className='text-center mb-5'), html.P("LEMBRE-SE QUE É APENAS UM MODELO DE TESTE ACADÊMICO.RESULTADO SEM VALIDADE MÉDICA LEGAL", 
                                                                                                               style={'color': 'red'},
                                                                                                               className='text-center mb-3')
